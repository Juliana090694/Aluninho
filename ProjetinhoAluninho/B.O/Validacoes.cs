...
namespace ProjetinhoAluninho
{
    class Validacoes
    {
        public static bool ValidarCpf(Aluno aluno)
        {
        ...
        public static bool ValidarCpf(Professor professor)
        {
            int[] multiplicador1 = new int[9] { 10, 9, 8, 7, 6, 5, 4, 3, 2 };
            int[] multiplicador2 = new int[10] { 11, 10, 9, 8, 7, 6, 5, 4, 3, 2 };
            string tempCpf;
            ...
            return professor.cpf.EndsWith(digito);
        }
    }
}
